...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-09-12T20:31:19.639240" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/call-for-new-members-for-the-community-code-of-conduct-committee-2711/">Call for New Members for the Community Code of Conduct Committee</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-09-11 by PostgreSQL Code of Conduct Committee</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgexporter-04-2707/">pgexporter 0.4</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-09-11 by Red Hat</li>
              </ul>
            </li>
 ...
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/698"> Why People care about PostGIS and Postgres and FOSS4GNA</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;REGINA OBE</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-09-10</li>
            </ul>
          </div>
        </div>
